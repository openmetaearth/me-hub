...
export const MsgUpdateRollapp = {
  encode(message: MsgUpdateRollapp, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.creator !== "") {
      writer.uint32(10).string(message.creator);
    }
    if (message.rollappId !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): MsgUpdateRollapp {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const MsgUpdateRollappResponse = {
  encode(_: MsgUpdateRollappResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): MsgUpdateRollappResponse {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromPartial<I extends Exact<DeepPartial<MsgUpdateRollappResponse>, I>>(_: I): MsgUpdateRollappResponse {
    const message = createBaseMsgUpdateRollappResponse();
    return message;
  },
};
...
export class MsgClientImpl implements Msg {
  ...
  CreateRollapp(request: MsgCreateRollapp): Promise<MsgCreateRollappResponse> {
    ...
    const promise = this.rpc.request("metaearth.rollapp.Msg", "CreateRollapp", data);
  ...
  SkipDelayRollapp(request: MsgSkipDelayRollapp): Promise<MsgSkipDelayRollappResponse> {
    ...
    const promise = this.rpc.request("metaearth.rollapp.Msg", "SkipDelayRollapp", data);
  ...
  UpdateState(request: MsgUpdateState): Promise<MsgUpdateStateResponse> {
    ...
    const promise = this.rpc.request("metaearth.rollapp.Msg", "UpdateState", data);
  ...
  UpdateRollapp(request: MsgUpdateRollapp): Promise<MsgUpdateRollappResponse> {
    ...
    const promise = this.rpc.request("metaearth.rollapp.Msg", "UpdateRollapp", data);
    return promise.then((data) => MsgUpdateRollappResponse.decode(new _m0.Reader(data)));
  }
}
