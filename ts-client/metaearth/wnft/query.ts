...
export const QueryClassAddressRequest: MessageFns<QueryClassAddressRequest> = {
  encode(message: QueryClassAddressRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.classId !== "") {
  ...
  create<I extends Exact<DeepPartial<QueryClassAddressRequest>, I>>(base?: I): QueryClassAddressRequest {
...
export const QueryClassAddressResponse: MessageFns<QueryClassAddressResponse> = {
  encode(message: QueryClassAddressResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  fromJSON(object: any): QueryClassAddressResponse {
    return {
      ...
      totalSupply: isSet(object.totalSupply)
        ...
        : 0,
      nfts: globalThis.Array.isArray(object?.nfts) ? object.nfts.map((e: any) => globalThis.String(e)) : [],
  ...
  create<I extends Exact<DeepPartial<QueryClassAddressResponse>, I>>(base?: I): QueryClassAddressResponse {
...
export const QueryNftFilterResponse: MessageFns<QueryNftFilterResponse> = {
  ...
  fromJSON(object: any): QueryNftFilterResponse {
    return {
      nfts: globalThis.Array.isArray(object?.nfts) ? object.nfts.map((e: any) => NftList.fromJSON(e)) : [],
      pagination: isSet(object.pagination) ? PageResponse.fromJSON(object.pagination) : undefined,
    };
  },
  ...
  create<I extends Exact<DeepPartial<QueryNftFilterResponse>, I>>(base?: I): QueryNftFilterResponse {
