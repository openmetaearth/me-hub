...
export const MsgUpdateDidStatusResponse: MessageFns<MsgUpdateDidStatusResponse> = {
  ...
  create<I extends Exact<DeepPartial<MsgUpdateDidStatusResponse>, I>>(base?: I): MsgUpdateDidStatusResponse {
...
export const MsgCreateService: MessageFns<MsgCreateService> = {
  ...
  fromJSON(object: any): MsgCreateService {
    return {
      ...
      issuers: globalThis.Array.isArray(object?.issuers) ? object.issuers.map((e: any) => globalThis.String(e)) : [],
    };
  },
...
export const MsgCreateServiceResponse: MessageFns<MsgCreateServiceResponse> = {
  ...
  create<I extends Exact<DeepPartial<MsgCreateServiceResponse>, I>>(base?: I): MsgCreateServiceResponse {
...
export const MsgUpdateServiceStatus: MessageFns<MsgUpdateServiceStatus> = {
  ...
  create<I extends Exact<DeepPartial<MsgUpdateServiceStatus>, I>>(base?: I): MsgUpdateServiceStatus {
...
export const MsgUpdateServiceStatusResponse: MessageFns<MsgUpdateServiceStatusResponse> = {
  encode(_: MsgUpdateServiceStatusResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },
  ...
  create<I extends Exact<DeepPartial<MsgUpdateServiceStatusResponse>, I>>(base?: I): MsgUpdateServiceStatusResponse {
...
export const MsgCreateVC: MessageFns<MsgCreateVC> = {
  ...
  fromJSON(object: any): MsgCreateVC {
    return {
      ...
      filters: globalThis.Array.isArray(object?.filters) ? object.filters.map((e: any) => bytesFromBase64(e)) : [],
    };
  },
