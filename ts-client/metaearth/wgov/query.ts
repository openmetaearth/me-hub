...
export const QueryMeTallyResultRequest: MessageFns<QueryMeTallyResultRequest> = {
  encode(message: QueryMeTallyResultRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  create<I extends Exact<DeepPartial<QueryMeTallyResultRequest>, I>>(base?: I): QueryMeTallyResultRequest {
...
export const QueryMeTallyResultResponse: MessageFns<QueryMeTallyResultResponse> = {
  encode(message: QueryMeTallyResultResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  create<I extends Exact<DeepPartial<QueryMeTallyResultResponse>, I>>(base?: I): QueryMeTallyResultResponse {
