...
export const CreateDenomMetadataProposal: MessageFns<CreateDenomMetadataProposal> = {
  encode(message: CreateDenomMetadataProposal, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.title !== "") {
  ...
  create<I extends Exact<DeepPartial<CreateDenomMetadataProposal>, I>>(base?: I): CreateDenomMetadataProposal {
...
export const UpdateDenomMetadataProposal: MessageFns<UpdateDenomMetadataProposal> = {
  encode(message: UpdateDenomMetadataProposal, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.title !== "") {
      writer.uint32(10).string(message.title);
    }
    if (message.description !== "") {
  ...
  create<I extends Exact<DeepPartial<UpdateDenomMetadataProposal>, I>>(base?: I): UpdateDenomMetadataProposal {
