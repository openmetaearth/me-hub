...
function createBaseRelayer(): Relayer {
  return { relayerAddress: "", externalAddress: "", delegateAmount: "", startHeight: 0, online: false, slashTimes: 0 };
}
...
export const LastObservedBlockHeight: MessageFns<LastObservedBlockHeight> = {
  encode(message: LastObservedBlockHeight, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
...
function createBaseOutgoingTxBatch(): OutgoingTxBatch {
  return { batchNonce: 0, batchTimeout: 0, transactions: [], tokenContract: "", block: 0, feeReceive: "" };
}
