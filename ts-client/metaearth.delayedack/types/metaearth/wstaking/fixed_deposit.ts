...
export const RegionAllFixedDepositCfg: MessageFns<RegionAllFixedDepositCfg> = {
  encode(message: RegionAllFixedDepositCfg, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.regionId !== "") {
      writer.uint32(10).string(message.regionId);
    }
  ...
  toJSON(message: RegionAllFixedDepositCfg): unknown {
    ...
    if (message.RegionFixedDepositCfg?.length) {
      obj.RegionFixedDepositCfg = message.RegionFixedDepositCfg.map((e) => RegionFixedDepositCfg.toJSON(e));
    }
    return obj;
  },

  create<I extends Exact<DeepPartial<RegionAllFixedDepositCfg>, I>>(base?: I): RegionAllFixedDepositCfg {
