...
export const MsgRepalceProposer = {
  encode(message: MsgRepalceProposer, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.rollappId !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): MsgRepalceProposer {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): MsgRepalceProposer {
    return {
      rollappId: isSet(object.rollappId) ? String(object.rollappId) : "",
      oldProposer: isSet(object.oldProposer) ? String(object.oldProposer) : "",
  ...
  toJSON(message: MsgRepalceProposer): unknown {
    const obj: any = {};
    message.rollappId !== undefined && (obj.rollappId = message.rollappId);
    message.oldProposer !== undefined && (obj.oldProposer = message.oldProposer);
...
export const MsgStoreReplaceProposer = {
  encode(message: MsgStoreReplaceProposer, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.replaceProposer !== undefined) {
      MsgRepalceProposer.encode(message.replaceProposer, writer.uint32(10).fork()).ldelim();
    }
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): MsgStoreReplaceProposer {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          break;
        case 2:
          message.hubBlockHeight = longToNumber(reader.int64() as Long);
          break;
        default:
          reader.skipType(tag & 7);
          break;
  ...
  fromJSON(object: any): MsgStoreReplaceProposer {
    return {
      replaceProposer: isSet(object.replaceProposer) ? MsgRepalceProposer.fromJSON(object.replaceProposer) : undefined,
      hubBlockHeight: isSet(object.hubBlockHeight) ? Number(object.hubBlockHeight) : 0,
    };
  },

  toJSON(message: MsgStoreReplaceProposer): unknown {
    const obj: any = {};
    message.replaceProposer !== undefined
      && (obj.replaceProposer = message.replaceProposer
        ? MsgRepalceProposer.toJSON(message.replaceProposer)
        : undefined);
    message.hubBlockHeight !== undefined && (obj.hubBlockHeight = Math.round(message.hubBlockHeight));
    return obj;
  },
