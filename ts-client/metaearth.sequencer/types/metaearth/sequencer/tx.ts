...
export const MsgReplaceProposerRequest = {
  encode(message: MsgReplaceProposerRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.creator !== "") {
      writer.uint32(10).string(message.creator);
    }
    if (message.replaceProposer !== undefined) {
      MsgRepalceProposer.encode(message.replaceProposer, writer.uint32(18).fork()).ldelim();
    }
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): MsgReplaceProposerRequest {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const MsgReplaceProposerResponse = {
  encode(_: MsgReplaceProposerResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): MsgReplaceProposerResponse {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export class MsgClientImpl implements Msg {
  ...
  CreateSequencer(request: MsgCreateSequencer): Promise<MsgCreateSequencerResponse> {
    ...
    const promise = this.rpc.request("metaearth.sequencer.Msg", "CreateSequencer", data);
    return promise.then((data) => MsgCreateSequencerResponse.decode(new _m0.Reader(data)));
  }

  Unbond(request: MsgUnbond): Promise<MsgUnbondResponse> {
    const data = MsgUnbond.encode(request).finish();
    const promise = this.rpc.request("metaearth.sequencer.Msg", "Unbond", data);
  ...
  ReplaceProposer(request: MsgReplaceProposerRequest): Promise<MsgReplaceProposerResponse> {
    ...
    const promise = this.rpc.request("metaearth.sequencer.Msg", "ReplaceProposer", data);
    return promise.then((data) => MsgReplaceProposerResponse.decode(new _m0.Reader(data)));
  }
}
