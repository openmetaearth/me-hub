...
export { MsgUpdateGroup, MsgJoinGroup, MsgCreateGroup, MsgLeaveGroupRequest, MsgDeleteGroup };
...
export const txClient = ({ signer, prefix, addr }: TxClientOptions = { addr: "http://localhost:26657", prefix: "cosmos" }) => {
  ...
  return {
		...
		async sendMsgJoinGroup({ value, fee, memo }: sendMsgJoinGroupParams): Promise<DeliverTxResponse> {
			if (!signer) {
		...
		msgUpdateGroup({ value }: msgUpdateGroupParams): EncodeObject {
			try {
				return { typeUrl: "/metaearth.megroup.MsgUpdateGroup", value: MsgUpdateGroup.fromPartial( value ) }  
			} catch (e: any) {
		...
		msgCreateGroup({ value }: msgCreateGroupParams): EncodeObject {
			try {
				return { typeUrl: "/metaearth.megroup.MsgCreateGroup", value: MsgCreateGroup.fromPartial( value ) }  
			} catch (e: any) {
...
class SDKModule {
	...
	constructor(client: IgniteClient) {		
		...
		this.structure =  {
						...
						QueryAllGroupMemberCountRequest: getStructure(typeQueryAllGroupMemberCountRequest.fromPartial({})),
						QueryAllGroupMemberCountResponse: getStructure(typeQueryAllGroupMemberCountResponse.fromPartial({})),
