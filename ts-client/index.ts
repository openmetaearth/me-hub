...
import { Module as MetaearthWgov, msgTypes as MetaearthWgovMsgTypes } from './metaearth.wgov'
import { Module as MetaearthWnft, msgTypes as MetaearthWnftMsgTypes } from './metaearth.wnft'
import { Module as MetaearthWstaking, msgTypes as MetaearthWstakingMsgTypes } from './metaearth.wstaking'
...
const Client = IgniteClient.plugin([
    CosmosAuthV1Beta1, CosmosAuthzV1Beta1, CosmosBaseNodeV1Beta1, CosmosBaseTendermintV1Beta1, CosmosConsensusV1, CosmosCrisisV1Beta1, CosmosEvidenceV1Beta1, CosmosFeegrantV1Beta1, CosmosMintV1Beta1, CosmosParamsV1Beta1, CosmosSlashingV1Beta1, CosmosTxV1Beta1, CosmosUpgradeV1Beta1, CosmosVestingV1Beta1, CosmwasmWasmV1, EthermintEvmV1, EthermintFeemarketV1, IbcApplicationsInterchainAccountsHostV1, IbcApplicationsTransferV1, IbcCoreChannelV1, IbcCoreClientV1, IbcCoreConnectionV1, MetaearthDao, MetaearthDelayedack, MetaearthDid, MetaearthEibc, MetaearthKyc, MetaearthMegroup, MetaearthRollapp, MetaearthSequencer, MetaearthWgov, MetaearthWnft, MetaearthWstaking, PacketforwardV1
]);
