...
replace (
	//github.com/cosmos/cosmos-sdk => github.com/st-chain/cosmos-sdk v0.0.0-20260313023157-36f01ea29eec
	...
	// go-ethereum v1.10.26 requires an unavailable pseudo-version; pin to a released version
