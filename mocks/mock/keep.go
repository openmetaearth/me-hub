...
type MockRegion struct {
	...
	RegionShare      sdkmath.Int       `protobuf:"bytes,9,opt,name=region_share,json=regionShare,proto3,customtype=cosmossdk.io/math.Int" json:"region_share"`                       //nolint:revive
	DelegateInterest sdkmath.LegacyDec `protobuf:"bytes,10,opt,name=delegate_interest,json=delegateInterest,proto3,customtype=cosmossdk.io/math.LegacyDec" json:"delegate_interest"` //nolint:revive
	DelegateAmount   sdkmath.Int       `protobuf:"bytes,11,opt,name=delegate_amount,json=delegateAmount,proto3,customtype=cosmossdk.io/math.Int" json:"delegate_amount"`             //nolint:revive
}
