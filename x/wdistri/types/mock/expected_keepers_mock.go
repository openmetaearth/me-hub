...
import (
	...
	types1 "github.com/openmetaearth/me-hub/x/wstaking/types"
)
...
func (m *MockStakingKeeper) GetAllRegionI(ctx types.Context) []types1.RegionI {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetAllRegionI", ctx)
	ret0, _ := ret[0].([]types1.RegionI)
	return ret0
}
