...
import (
	...
	"github.com/st-chain/me-hub/x/wdistri/client/cli"
...
func (AppModuleBasic) RegisterGRPCGatewayRoutes(clientCtx client.Context, mux *runtime.ServeMux) {
	...
	distritypes.RegisterQueryHandlerClient(context.Background(), mux, distritypes.NewQueryClient(clientCtx))
}
...
func (AppModuleBasic) GetQueryCmd() *cobra.Command {
	c := cli.GetQueryCmd(types.StoreKey)
	return c
}
...
func (am AppModule) RegisterServices(cfg module.Configurator) {
	...
	distritypes.RegisterQueryServer(cfg.QueryServer(), distritkeeper.NewQuerier(*am.keeper.WrapDistrKeeper.Keeper))
}
