...
var (
	...
	ErrSubAccountAlreadyExists     = errors.Register(ModuleName, 105, "sub account already set on DID")
	ErrSubAccountAlreadyRegistered = errors.Register(ModuleName, 106, "sub account already registered by another DID")
)
