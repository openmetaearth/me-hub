...
var (
	...
	ErrUnknownRollappID          = gerrc.ErrNotFound.Wrap("rollapp")
	ErrExistingReplaceProposer   = errorsmod.Register(ModuleName, 1020, "replace proposer request already exists")
	ErrorExceedAuthoredBlockHeight = errorsmod.Register(ModuleName, 1022, "exceed authored block height for replace proposer")
)
