...
func NewMsgRemoveFixedDepositCfg(admin, regionId string, term int64) *MsgRemoveFixedDepositCfg {
...
func NewMsgSetFixedDepositCfgStatus(admin, regionId string, term int64, status FIXED_DEPOSIT_CFG_STATUS) *MsgSetFixedDepositCfgStatus {
