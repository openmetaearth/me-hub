...
var (
	...
	pattern_Query_Stakes_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"cosmos", "staking", "v1beta1", "stakes"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_QueryAllRecord_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"cosmos", "staking", "v1beta1", "records"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_QueryRecordByAddress_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"cosmos", "staking", "v1beta1", "record", "account"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_QueryReviewRecordByID_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"cosmos", "staking", "v1beta1", "review_record", "actionNumber"}, "", runtime.AssumeColonVerbOpt(true)))
)
