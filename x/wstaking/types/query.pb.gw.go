...
var (
	pattern_Query_Region_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"metaearth", "wstaking", "region", "regionId"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_AllRegion_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"metaearth", "wstaking", "all-region"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_DelegationRewards_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"metaearth", "wstaking", "delegation-rewards", "delegator_address"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_FixedDepositTotalAmount_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"metaearth", "wstaking", "fixed_deposit_total_amount"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_FixedDepositAmountByMeid_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"metaearth", "wstaking", "fixed_deposit_amount_by_meid", "account"}, "", runtime.AssumeColonVerbOpt(false)))
	...
	pattern_Query_FixedDepositByRegion_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4, 1, 0, 4, 1, 5, 5}, []string{"cosmos", "staking", "v1beta1", "fixed_deposit_by_region", "region_id", "query_type"}, "", runtime.AssumeColonVerbOpt(false)))
	...
	pattern_Query_FixedDepositAll_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"metaearth", "wstaking", "fixed_deposit"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_FixedDepositCfg_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"metaearth", "wstaking", "fixed_deposit_cfg"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_FixedDepositCfgByTerm_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"metaearth", "wstaking", "fixed_deposit_cfg_by_term"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_Delegation_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"metaearth", "wstaking", "delegation", "delegator_addr"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_AllDelegations_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"metaearth", "wstaking", "all-delegations"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_Stakes_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"metaearth", "wstaking", "stakes"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_QueryAllRecord_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"metaearth", "wstaking", "records"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_QueryRecordByAddress_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"metaearth", "wstaking", "record", "account"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_QueryReviewRecordByID_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"metaearth", "wstaking", "review_record", "action_number"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_RegionWithdrawer_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"metaearth", "wstaking", "region_withdrawer", "region_id"}, "", runtime.AssumeColonVerbOpt(false)))
)
