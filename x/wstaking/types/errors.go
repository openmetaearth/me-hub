...
var (
	...
	ErrAssertDelegation        = sdkerrors.Register(ModuleName, 16, "The delegation structure assertion error.")
	ErrDistributionIncome      = sdkerrors.Register(ModuleName, 18, "distribution income err.")
	ErrDistributionOther       = sdkerrors.Register(ModuleName, 19, "distribution err.")
