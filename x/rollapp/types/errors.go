...
var (
	...
	// ErrCheckGlobalDao is returned when a non-DAO address attempts a DAO-only action.
	ErrCheckGlobalDao = errorsmod.Register(ModuleName, 2040, "invalid global dao")
)
