...
import (
	...
	types "github.com/st-chain/me-hub/x/rollup/types"
...
func (m *QuerySkipDelayRollappRequest) Reset()         { *m = QuerySkipDelayRollappRequest{} }
...
func (m *QuerySkipDelayRollappRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_QuerySkipDelayRollappRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *QuerySkipDelayRollappRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_QuerySkipDelayRollappRequest.Merge(m, src)
}
func (m *QuerySkipDelayRollappRequest) XXX_Size() int {
	return m.Size()
}
func (m *QuerySkipDelayRollappRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_QuerySkipDelayRollappRequest.DiscardUnknown(m)
}

var xxx_messageInfo_QuerySkipDelayRollappRequest proto.InternalMessageInfo

type QuerySkipDelayRollappResponse struct {
	Rollapps []string `protobuf:"bytes,1,rep,name=rollapps,proto3" json:"rollapps,omitempty"`
}

func (m *QuerySkipDelayRollappResponse) Reset()         { *m = QuerySkipDelayRollappResponse{} }
...
func (m *QuerySkipDelayRollappResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_QuerySkipDelayRollappResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *QuerySkipDelayRollappResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_QuerySkipDelayRollappResponse.Merge(m, src)
}
func (m *QuerySkipDelayRollappResponse) XXX_Size() int {
	return m.Size()
}
func (m *QuerySkipDelayRollappResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_QuerySkipDelayRollappResponse.DiscardUnknown(m)
}

var xxx_messageInfo_QuerySkipDelayRollappResponse proto.InternalMessageInfo

func (m *QuerySkipDelayRollappResponse) GetRollapps() []string {
	if m != nil {
		return m.Rollapps
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*QuerySkipDelayRollappRequest)(nil), "dymensionxyz.dymension.rollapp.QuerySkipDelayRollappRequest")
	proto.RegisterType((*QuerySkipDelayRollappResponse)(nil), "dymensionxyz.dymension.rollapp.QuerySkipDelayRollappResponse")
}
...
var fileDescriptor_00a0238fb38306fa = []byte{
	...
	,
}
...
type QueryClient interface {
	...
	GetSubmitterBlockStatics(ctx context.Context, in *MsgSubmitBlockStaticsRequest, opts ...grpc.CallOption) (*MsgSubmitBlockStaticsResponse, error)
	GetSubmitBlockDaInfo(ctx context.Context, in *MsgGetBlockDaInfoRequest, opts ...grpc.CallOption) (*MsgGetBlockDaInfoResponse, error)
	//查询所有的为处理挑战信息
	GetAppendingDaFraudChallenge(ctx context.Context, in *MsgGetDaFraudChallengeRequest, opts ...grpc.CallOption) (*MsgGetDaFraudChallengeResponse, error)
	QueryElectionResult(ctx context.Context, in *types.QueryElectionRequest, opts ...grpc.CallOption) (*types.QueryElectionResponse, error)
}
...
func (c *queryClient) SkipDelayRollapp(ctx context.Context, in *QuerySkipDelayRollappRequest, opts ...grpc.CallOption) (*QuerySkipDelayRollappResponse, error) {
	out := new(QuerySkipDelayRollappResponse)
	err := c.cc.Invoke(ctx, "/dymensionxyz.dymension.rollapp.Query/SkipDelayRollapp", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) GetLastSubmitBlockInfo(ctx context.Context, in *MsgLastSubmitBlkRequest, opts ...grpc.CallOption) (*MsgLastSubmitBlkResponse, error) {
	out := new(MsgLastSubmitBlkResponse)
	err := c.cc.Invoke(ctx, "/dymensionxyz.dymension.rollapp.Query/GetLastSubmitBlockInfo", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) GetSubmitterBlockStatics(ctx context.Context, in *MsgSubmitBlockStaticsRequest, opts ...grpc.CallOption) (*MsgSubmitBlockStaticsResponse, error) {
	out := new(MsgSubmitBlockStaticsResponse)
	err := c.cc.Invoke(ctx, "/dymensionxyz.dymension.rollapp.Query/GetSubmitterBlockStatics", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) GetSubmitBlockDaInfo(ctx context.Context, in *MsgGetBlockDaInfoRequest, opts ...grpc.CallOption) (*MsgGetBlockDaInfoResponse, error) {
	out := new(MsgGetBlockDaInfoResponse)
	err := c.cc.Invoke(ctx, "/dymensionxyz.dymension.rollapp.Query/GetSubmitBlockDaInfo", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) GetAppendingDaFraudChallenge(ctx context.Context, in *MsgGetDaFraudChallengeRequest, opts ...grpc.CallOption) (*MsgGetDaFraudChallengeResponse, error) {
	out := new(MsgGetDaFraudChallengeResponse)
	err := c.cc.Invoke(ctx, "/dymensionxyz.dymension.rollapp.Query/GetAppendingDaFraudChallenge", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) QueryElectionResult(ctx context.Context, in *types.QueryElectionRequest, opts ...grpc.CallOption) (*types.QueryElectionResponse, error) {
	out := new(types.QueryElectionResponse)
	err := c.cc.Invoke(ctx, "/dymensionxyz.dymension.rollapp.Query/QueryElectionResult", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type QueryServer interface {
	...
	GetSubmitterBlockStatics(context.Context, *MsgSubmitBlockStaticsRequest) (*MsgSubmitBlockStaticsResponse, error)
	GetSubmitBlockDaInfo(context.Context, *MsgGetBlockDaInfoRequest) (*MsgGetBlockDaInfoResponse, error)
	//查询所有的为处理挑战信息
	GetAppendingDaFraudChallenge(context.Context, *MsgGetDaFraudChallengeRequest) (*MsgGetDaFraudChallengeResponse, error)
	QueryElectionResult(context.Context, *types.QueryElectionRequest) (*types.QueryElectionResponse, error)
}
...
func (*UnimplementedQueryServer) GetLastSubmitBlockInfo(ctx context.Context, req *MsgLastSubmitBlkRequest) (*MsgLastSubmitBlkResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetLastSubmitBlockInfo not implemented")
}
func (*UnimplementedQueryServer) GetSubmitterBlockStatics(ctx context.Context, req *MsgSubmitBlockStaticsRequest) (*MsgSubmitBlockStaticsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetSubmitterBlockStatics not implemented")
}
func (*UnimplementedQueryServer) GetSubmitBlockDaInfo(ctx context.Context, req *MsgGetBlockDaInfoRequest) (*MsgGetBlockDaInfoResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetSubmitBlockDaInfo not implemented")
}
func (*UnimplementedQueryServer) GetAppendingDaFraudChallenge(ctx context.Context, req *MsgGetDaFraudChallengeRequest) (*MsgGetDaFraudChallengeResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetAppendingDaFraudChallenge not implemented")
}
func (*UnimplementedQueryServer) QueryElectionResult(ctx context.Context, req *types.QueryElectionRequest) (*types.QueryElectionResponse, error) {
...
func _Query_SkipDelayRollapp_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(QuerySkipDelayRollappRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(QueryServer).SkipDelayRollapp(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/dymensionxyz.dymension.rollapp.Query/SkipDelayRollapp",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(QueryServer).SkipDelayRollapp(ctx, req.(*QuerySkipDelayRollappRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Query_GetLastSubmitBlockInfo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(MsgLastSubmitBlkRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(QueryServer).GetLastSubmitBlockInfo(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/dymensionxyz.dymension.rollapp.Query/GetLastSubmitBlockInfo",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(QueryServer).GetLastSubmitBlockInfo(ctx, req.(*MsgLastSubmitBlkRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Query_GetSubmitterBlockStatics_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(MsgSubmitBlockStaticsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(QueryServer).GetSubmitterBlockStatics(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/dymensionxyz.dymension.rollapp.Query/GetSubmitterBlockStatics",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(QueryServer).GetSubmitterBlockStatics(ctx, req.(*MsgSubmitBlockStaticsRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Query_GetSubmitBlockDaInfo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(MsgGetBlockDaInfoRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(QueryServer).GetSubmitBlockDaInfo(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/dymensionxyz.dymension.rollapp.Query/GetSubmitBlockDaInfo",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(QueryServer).GetSubmitBlockDaInfo(ctx, req.(*MsgGetBlockDaInfoRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Query_GetAppendingDaFraudChallenge_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(MsgGetDaFraudChallengeRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(QueryServer).GetAppendingDaFraudChallenge(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/dymensionxyz.dymension.rollapp.Query/GetAppendingDaFraudChallenge",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(QueryServer).GetAppendingDaFraudChallenge(ctx, req.(*MsgGetDaFraudChallengeRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Query_QueryElectionResult_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(types.QueryElectionRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/dymensionxyz.dymension.rollapp.Query/QueryElectionResult",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(QueryServer).QueryElectionResult(ctx, req.(*types.QueryElectionRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Query_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _Query_SkipDelayRollapp_Handler,
		},
		{
			MethodName: "GetLastSubmitBlockInfo",
			Handler:    _Query_GetLastSubmitBlockInfo_Handler,
		},
		{
			MethodName: "GetSubmitterBlockStatics",
			Handler:    _Query_GetSubmitterBlockStatics_Handler,
		},
		{
			MethodName: "GetSubmitBlockDaInfo",
			Handler:    _Query_GetSubmitBlockDaInfo_Handler,
		},
		{
			MethodName: "GetAppendingDaFraudChallenge",
			Handler:    _Query_GetAppendingDaFraudChallenge_Handler,
		},
		{
...
func (m *QuerySkipDelayRollappRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *QuerySkipDelayRollappRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *QuerySkipDelayRollappRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *QuerySkipDelayRollappResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *QuerySkipDelayRollappResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *QuerySkipDelayRollappResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if len(m.Rollapps) > 0 {
		for iNdEx := len(m.Rollapps) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = encodeVarintQuery(dAtA, i, uint64(len(m.Rollapps[iNdEx])))
			i--
			dAtA[i] = 0xa
		}
	}
...
func (m *QuerySkipDelayRollappRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *QuerySkipDelayRollappResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *QuerySkipDelayRollappRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: QuerySkipDelayRollappRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: QuerySkipDelayRollappRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		default:
			iNdEx = preIndex
...
func (m *QuerySkipDelayRollappResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: QuerySkipDelayRollappResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: QuerySkipDelayRollappResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
