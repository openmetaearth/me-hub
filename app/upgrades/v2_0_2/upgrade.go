...
func migrateRegions(ctx sdk.Context, stakingKeeper *wstakingkeeper.Keeper) {
	...
	for index, validator := range validators {
		if validator.Description.RegionID == wstakingtypes.MeEarthRegionId ||
			regionIds[index] == wstakingtypes.MeEarthRegionId {
			continue
		}
